...
describe("builder/nested arrays inheritance flag combinations", () => {
	it("handles deeply nested arrays with various flag combinations in inheritance scenarios", () => {
		...
		const result1 = ExtendedButtonCls.create([
			// Initial setup
			[
				{
					variant: {
		...
		expect(result1.slots.icon()).toBe("primary-icon after-clear");
		...
		const result2 = ExtendedButtonCls.create([
			// Initial setup
			[
				{
					variant: {
		...
		expect(result2.slots.icon()).toBe("primary-icon after-clear");
		...
		const result3 = ExtendedButtonCls.create([
			// Initial setup
			[
				{
					variant: {
		...
		expect(result3.slots.icon()).toBe("primary-icon after-clear");
