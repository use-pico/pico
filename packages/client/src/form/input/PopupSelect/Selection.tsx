...
export namespace Selection {
	...
	> extends Pick<Content.Props<TValuesSchema, TItemSchema, TQuerySchema, TMode>, "schema" | "onSelect" | "name" | "table" | "tableProps" | "selectionStore" | "mode" | "defaultQuery" | "icon" | "theme"> {
	}
}
		...
		>
			...
			>
				<Button
					...
					onClick={() => {
						const selection = mode === "single" ? ($selection.item()?.id || "") : [...$selection.selection.values()].map(item => item.id);
						onChange(selection);
