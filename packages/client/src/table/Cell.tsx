    ...
    >
        ...
        >
            ...
            >
                ...
                />}
                {render?.filters && render.filters.compare?.lte && !render.filters.compare.lte.isFilter(filter) && <Icon
                    icon={LteIcon}
                    cx={[
                        "group-hover:visible",
                        "invisible",
                ...
                />}
                {render.filters && render?.filters.compare?.gte && !render.filters.compare.gte.isFilter(filter) && <Icon
