import { cssOf, type IHrefProps } from "@use-pico/common";
...
export namespace Breadcrumbs {
	...
	export type Breadcrumb = Label | Link;
...
export const Breadcrumbs: FC<Breadcrumbs.Props> = ({
	...
	return (
		<div className={cssOf("flex flex-row")}>
					...
					case "label":
						return (
							<div
								...
								className={cssOf("flex items-center")}
							>
								<div className={cssOf("flex items-center")}>
									{item.icon && (
										<Icon
											icon={item.icon}
											size={"xl"}
