...
export namespace Tag_PopupMultiSelect {
	export interface Props extends PopupMultiSelect.PropsEx<Tag_Table.Data> {
		group?: string;
	}
}

export const Tag_PopupMultiSelect: FC<Tag_PopupMultiSelect.Props> = ({
	group,
	...props
}) => {
	return (
		<PopupMultiSelect<Tag_Table.Data>
			icon={TagIcon}
			table={(props) => (
				<Tag_Table
					group={group}
